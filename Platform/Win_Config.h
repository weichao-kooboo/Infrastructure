...
/* symbol 'hky_rbtree_min' has been defined, but not referenced */
...
#define HKY_PTR_SIZE            8
#define HKY_SIZE_T_LEN          (sizeof("-9223372036854775808") - 1)
#define HKY_MAX_SIZE_T_VALUE    9223372036854775807
#define HKY_TIME_T_LEN          (sizeof("-9223372036854775808") - 1)
#define HKY_TIME_T_SIZE         8
#define HKY_MAX_TIME_T_VALUE    9223372036854775807

#else

#define HKY_PTR_SIZE            4
#define HKY_SIZE_T_LEN          (sizeof("-2147483648") - 1)
#define HKY_MAX_SIZE_T_VALUE    2147483647
#define HKY_TIME_T_LEN          (sizeof("-2147483648") - 1)
#define HKY_TIME_T_SIZE         4
#define HKY_MAX_TIME_T_VALUE    2147483647

#endif


#define HKY_OFF_T_LEN           (sizeof("-9223372036854775807") - 1)
#define HKY_MAX_OFF_T_VALUE     9223372036854775807
#define HKY_SIG_ATOMIC_T_SIZE   4


#define HKY_HAVE_LITTLE_ENDIAN  1
#define HKY_HAVE_NONALIGNED     1


#define HKY_WIN_NT        200000
...
#ifndef HKY_HAVE_WIN32_TRANSMITPACKETS
#define HKY_HAVE_WIN32_TRANSMITPACKETS  1
#define HKY_HAVE_WIN32_TRANSMITFILE     0
#endif

#ifndef HKY_HAVE_WIN32_TRANSMITFILE
#define HKY_HAVE_WIN32_TRANSMITFILE  1
#endif

#if (HKY_HAVE_WIN32_TRANSMITPACKETS) || (HKY_HAVE_WIN32_TRANSMITFILE)
#define HKY_HAVE_SENDFILE  1
#endif
...
#define HKY_HAVE_GETADDRINFO         1

#define hky_random               rand
#define hky_debug_init()


#endif // !_HKY_WIN32_CONFIG_H_INCLUDED_
